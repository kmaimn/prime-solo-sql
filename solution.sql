...
SELECT username FROM syntax_practice WHERE city ILIKE 'Chicago';
--2. Get all users with usernames that contain the letter a.
SELECT username FROM syntax_practice WHERE username ILIKE '%a%';
...
VALUES ('kim', 'st paul', 10, 10, 9999.99);
